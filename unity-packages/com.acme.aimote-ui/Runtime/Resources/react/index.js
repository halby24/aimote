  ...
  "../../node_modules/.pnpm/react-reconciler@0.29.2_react@18.3.1/node_modules/react-reconciler/cjs/react-reconciler-constants.development.js"(exports) {
    ...
    if (true) {
      (function() {
        ...
        var IdleEventPriority2 = IdleLane;
        var LegacyRoot2 = 0;
        ...
        exports.IdleEventPriority = IdleEventPriority2;
...
var require_constants = __commonJS({
  "../../node_modules/.pnpm/react-reconciler@0.29.2_react@18.3.1/node_modules/react-reconciler/constants.js"(exports, module2) {
    "use strict";
    if (false) {
      module2.exports = null;
    } else {
...
var require_react_reconciler_development = __commonJS({
  "../../node_modules/.pnpm/react-reconciler@0.29.2_react@18.3.1/node_modules/react-reconciler/cjs/react-reconciler.development.js"(exports, module2) {
    "use strict";
    if (true) {
      module2.exports = function $$$reconciler($$$hostConfig) {
        ...
        function processChildContext(fiber, type, parentContext) {
          {
            ...
            var childContext2 = instance.getChildContext();
            for (var contextKey in childContext2) {
            ...
            }
            {
              ...
              checkPropTypes(childContextTypes, childContext2, "child context", name);
            }
            return assign({}, parentContext, childContext2);
          }
        }
        ...
        function prepareToHydrateHostInstance(fiber, rootContainerInstance, hostContext2) {
          if (!supportsHydration) {
            throw new Error("Expected prepareToHydrateHostInstance() to never be called. This error is likely caused by a bug in React. Please file an issue.");
          }
          var instance = fiber.stateNode;
          var shouldWarnIfMismatchDev = !didSuspendOrErrorDEV;
          var updatePayload = hydrateInstance(instance, fiber.type, fiber.memoizedProps, rootContainerInstance, hostContext2, fiber, shouldWarnIfMismatchDev);
        ...
        exports2.batchedUpdates = batchedUpdates2;
...
var require_react_reconciler = __commonJS({
  "../../node_modules/.pnpm/react-reconciler@0.29.2_react@18.3.1/node_modules/react-reconciler/index.js"(exports, module2) {
    "use strict";
    if (false) {
      module2.exports = null;
    } else {
...
// ../../node_modules/.pnpm/@reactunity+renderer@0.16.6_react@18.3.1/node_modules/@reactunity/renderer/dist/src/renderer/renderer.js
var import_react = __toESM(require_react());
var import_constants4 = __toESM(require_constants());

// ../../node_modules/.pnpm/@reactunity+renderer@0.16.6_react@18.3.1/node_modules/@reactunity/renderer/dist/src/version.js
var version = "0.16.6";

// ../../node_modules/.pnpm/@reactunity+renderer@0.16.6_react@18.3.1/node_modules/@reactunity/renderer/dist/src/views/default-view.js
var import_jsx_runtime2 = __toESM(require_jsx_runtime());

// ../../node_modules/.pnpm/@reactunity+renderer@0.16.6_react@18.3.1/node_modules/@reactunity/renderer/dist/src/views/error-boundary.js
  ...
  (function(_super) {
    ...
    ErrorBoundary2.prototype.render = function() {
      ...
      if (this.state.hasError) {
        return (0, import_jsx_runtime.jsxs)("view", { id: "__react-unity-error-boundary", style: { color: "crimson", padding: 20, fontSize: 16 }, children: [(0, import_jsx_runtime.jsx)("view", { style: { marginBottom: "12px" }, children: ((_a = this.state.error) === null || _a === void 0 ? void 0 : _a.message) || "" }), (0, import_jsx_runtime.jsx)("view", { children: ((_b = this.state.error) === null || _b === void 0 ? void 0 : _b.stack) || "" })] });
      }
...
function DefaultView(_a) {
  ...
  return (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, { children: !withHelpers ? children : (0, import_jsx_runtime2.jsx)(ErrorBoundary, { children }, renderCount2) });
}

// ../../node_modules/.pnpm/@reactunity+renderer@0.16.6_react@18.3.1/node_modules/@reactunity/renderer/dist/src/renderer/async/objects.js
var ObjectsRepo = (
  /** @class */
  /* @__PURE__ */ (function() {
...
// ../../node_modules/.pnpm/@reactunity+renderer@0.16.6_react@18.3.1/node_modules/@reactunity/renderer/dist/src/renderer/async/reconciler.js
var import_react_reconciler = __toESM(require_react_reconciler());

// ../../node_modules/.pnpm/@reactunity+renderer@0.16.6_react@18.3.1/node_modules/@reactunity/renderer/dist/src/renderer/constants.js
var import_constants = __toESM(require_constants());

// ../../node_modules/.pnpm/@reactunity+renderer@0.16.6_react@18.3.1/node_modules/@reactunity/renderer/dist/src/renderer/diffing.js
...
var eventPriorities = {
  discrete: import_constants.DiscreteEventPriority,
  continuous: import_constants.ContinuousEventPriority,
  default: import_constants.DefaultEventPriority,
  idle: import_constants.IdleEventPriority
};
var textTypes = {
  text: true,
  icon: true,
...
var commonReconciler = {
  ...
  noTimeout: -1,
  scheduleTimeout: function(callback, delay2) {
...
// ../../node_modules/.pnpm/@reactunity+renderer@0.16.6_react@18.3.1/node_modules/@reactunity/renderer/dist/src/renderer/subcontexts/richtext.js
...
// ../../node_modules/.pnpm/@reactunity+renderer@0.16.6_react@18.3.1/node_modules/@reactunity/renderer/dist/src/renderer/subcontexts/svg.js
...
// ../../node_modules/.pnpm/@reactunity+renderer@0.16.6_react@18.3.1/node_modules/@reactunity/renderer/dist/src/renderer/subcontexts/index.js
var subContextRenderers = {
  richtext: stringifyRichText,
  svg: stringifySVG
};

// ../../node_modules/.pnpm/@reactunity+renderer@0.16.6_react@18.3.1/node_modules/@reactunity/renderer/dist/src/renderer/async/callbacks.js
...
var CallbacksRepo = (
  /** @class */
  (function(_super) {
    __extends2(CallbacksRepo2, _super);
...
// ../../node_modules/.pnpm/@reactunity+renderer@0.16.6_react@18.3.1/node_modules/@reactunity/renderer/dist/src/renderer/async/serializer.js
...
var hostConfig = __assign(__assign({}, commonReconciler), {
  ...
  createInstance: function(type, props, rootContainer, ctx, internalHandle) {
    ...
    if (ctx.type === "native") {
      ...
      var res = __assign(__assign({}, ctx), { refId });
      if (type === "richtext") {
        res.subContext = {
          type: "richtext",
          node: {
  ...
  createTextInstance: function(text, rootContainer, ctx, internalHandle) {
    if (ctx.type === "native") {
      ...
      if (rootContainer.fiberCache)
        rootContainer.fiberCache.setObject(refId, internalHandle);
      return __assign(__assign({}, ctx), { refId });
    } else if (ctx.type === "richtext" || ctx.type === "svg") {
      return __assign(__assign({}, ctx), { node: { text } });
    }
  },
...
var asyncReconciler = (0, import_react_reconciler.default)(hostConfig);

// ../../node_modules/.pnpm/@reactunity+renderer@0.16.6_react@18.3.1/node_modules/@reactunity/renderer/dist/src/renderer/sync/reconciler.js
...
var hostContext = {};
var childContext = {};
var hostConfig2 = __assign2(__assign2({}, commonReconciler), {
...
var syncReconciler = (0, import_react_reconciler2.default)(hostConfig2);
...
function render(element, options) {
  ...
  if (!hostRoot) {
    var mode = (options === null || options === void 0 ? void 0 : options.mode) === "legacy" ? import_constants4.LegacyRoot : import_constants4.ConcurrentRoot;
    if (isAsync) {
      ...
      hostRoot = asyncReconciler.createContainer(hostContainerInstance_1, mode, null, false, void 0, "", function(error) {
        return console.error(error);
      }, null);
    } else {
      hostRoot = syncReconciler.createContainer(hostContainer, mode, null, false, void 0, "", function(error) {
        return console.error(error);
      }, null);
    }
  ...
  if (shouldWrapWithHelpers) {
    ...
    element = (0, import_react.createElement)(DefaultView, viewWrapperProps, element);
  }
...
// ../shared-types/dist/ids.js
function makeSessionId(raw) {
  return raw;
}
function makeMessageId(raw) {
  return raw;
}
function makeRequestId(raw) {
  return raw;
}

// ../app-core/dist/store.js
...
var ChatStoreManager = class {
  constructor() {
    __publicField(this, "store", createStore());
  ...
  addAssistantMessage(sessionId, messageId) {
    const sid = makeSessionId(sessionId);
  ...
  appendMessageDelta(sessionId, messageId, delta) {
    const sid = makeSessionId(sessionId);
    const mid = makeMessageId(messageId);
  ...
  markMessageSent(sessionId, messageId) {
    const sid = makeSessionId(sessionId);
  ...
  markMessageError(sessionId, messageId) {
    const sid = makeSessionId(sessionId);
    this.updateMessage(sid, messageId, (msg) => ({
      ...msg,
      status: "error",
  ...
  setPermission(sessionId, requestId, payload) {
    const sid = makeSessionId(sessionId);
  ...
  addErrorMessage(sessionId, code, message) {
    const sid = makeSessionId(sessionId);
...
var ChatController = class {
  constructor(options) {
    ...
    __publicField(this, "storeManager");
    __publicField(this, "connectionStatus", "idle");
    __publicField(this, "configValidation", null);
    __publicField(this, "connectError", null);
    __publicField(this, "unsubscribe", null);
    __publicField(this, "activeSessionId", null);
    __publicField(this, "streamingMessageId", null);
    ...
    this.unsubscribe = this.transport.subscribe((event) => {
      switch (event.type) {
        ...
        case "sessionInfoUpdate":
          if (event.title !== void 0 && event.title !== null) {
  ...
  async startSession(workspace) {
    const input = workspace !== void 0 ? { workspace } : void 0;
  ...
  async approve(requestId, optionId) {
  ...
  async getAgentsConfig() {
    if (!this.transport.getAgentsConfig)
      return null;
    return this.transport.getAgentsConfig();
  }
  async saveAgentsConfig(config) {
...
// ../transport-relay/dist/mock-transport.js
var RelayMockTransport = class {
  constructor(options = {}) {
  ...
  async streamResponse(sessionId, messageId, text) {
...
function useChat({ controller: controller2 }) {
  const [store, setStore] = (0, import_react2.useState)(() => controller2.storeManager.getStore());
  const [connectionStatus, setConnectionStatus] = (0, import_react2.useState)(() => controller2.getConnectionStatus());
  const [inputValue] = (0, import_react2.useState)("");
  const [isSubmitting, setIsSubmitting] = (0, import_react2.useState)(false);
  const [configValidation, setConfigValidation] = (0, import_react2.useState)(null);
  const [connectError, setConnectError] = (0, import_react2.useState)(null);
  const controllerRef = (0, import_react2.useRef)(controller2);
  controllerRef.current = controller2;
  (0, import_react2.useEffect)(() => {
    const unsub = controller2.subscribe((s) => setStore(s));
  ...
  const approve = (0, import_react2.useCallback)(async (requestId, optionId) => {
...
function useAgentSettings({ controller: controller2, isOpen, onClose }) {
  const [agents, setAgents] = (0, import_react3.useState)([]);
  const [defaultAgent, setDefaultAgent] = (0, import_react3.useState)("");
  ...
  (0, import_react3.useEffect)(() => {
    ...
    setIsLoading(true);
    setError(null);
    void controller2.getAgentsConfig().then((config) => {
      if (cancelled)
        return;
      setIsLoading(false);
      if (config) {
  ...
  const updateAgent = (0, import_react3.useCallback)((index, field, value) => {
    setAgents((prev) => prev.map((a, i) => i === index ? { ...a, [field]: value } : a));
  }, []);
  const addAgent = (0, import_react3.useCallback)(() => {
    setAgents((prev) => [
      ...prev,
      { name: "", command: "", args: "", env: "", isDefault: false }
    ]);
  }, []);
  const removeAgent = (0, import_react3.useCallback)((index) => {
    setAgents((prev) => prev.filter((_, i) => i !== index));
  }, []);
  const setDefault = (0, import_react3.useCallback)((name) => {
  ...
  const save = (0, import_react3.useCallback)(async () => {
    ...
    try {
      ...
      await controller2.saveAgentsConfig(config);
    } catch (err) {
      setError(err instanceof Error ? err.message : String(err));
      setIsSaving(false);
      return;
    ...
    try {
      ...
      if (controller2.getConnectionStatus() !== "error") {
        await controller2.startSession();
      }
    } catch {
    }
  }, [agents, defaultAgent, controller2, onClose]);
  const viewModel = {
    isOpen,
    agents,
    defaultAgent,
...
function UsageBar({ usage }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("view", { style: { flexDirection: "row", alignItems: "center", gap: 8 }, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("text", { style: { fontSize: 12, color: "#666" }, children: [
      usage.percentage,
      "%"
    ] }),
    usage.costDisplay && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("text", { style: { fontSize: 12, color: "#888" }, children: usage.costDisplay })
  ] });
}
    ...
    "view",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("view", { style: { flexDirection: "row", alignItems: "center", gap: 8, minWidth: 0 }, children: [
          ...
          currentMode && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            "text",
            {
              style: {
                fontSize: 11,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("view", { style: { flexDirection: "row", alignItems: "center", gap: 8, flexShrink: 0 }, children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("view", { style: { flexDirection: "row", alignItems: "center", gap: 4 }, children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("text", { style: { fontSize: 12, color }, children: label })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            "button",
            {
...
function ThoughtBubble({ thought }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
    "view",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("view", { onClick: () => setCollapsed(!collapsed), children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("text", { style: { color: "#6366f1", fontWeight: "600", fontSize: 13 }, children: collapsed ? "\u25B6 Thinking..." : "\u25BC Thinking..." }) }),
        !collapsed && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("scroll", { style: { marginTop: 4, maxHeight: 120 }, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("text", { style: { color: "#555", fontSize: 13, whiteSpace: "pre-wrap" }, children: thought }) })
      ]
    }
  );
}
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
    "view",
    {
      ...
      children: active.map((tc) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("view", { style: { flexDirection: "row", alignItems: "center", gap: 8 }, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("text", { style: { color: "#555", fontSize: 13 }, children: tc.title })
      ] }, tc.toolCallId))
    }
  );
}
...
function MessageList({ messages }) {
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
    "scroll",
    {
      ...
      children: [
        messages.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("text", { style: { color: "#888", textAlign: "center", marginTop: 40 }, children: "\u30E1\u30C3\u30BB\u30FC\u30B8\u3092\u9001\u4FE1\u3057\u3066\u304F\u3060\u3055\u3044" }),
...
function PlanPanel({ plan }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
    "view",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("text", { style: { fontWeight: "600", marginBottom: 4, color: "#555", fontSize: 13 }, children: "Plan" }),
        plan.entries.map((entry, i) => /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
          "view",
          {
            style: {
              flexDirection: "row",
...
function ConnectionStatusPanel({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(
    "view",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("text", { style: { fontSize: 16, color: "#888" }, children: label }),
        configError && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("text", { style: { fontSize: 13, color: "#c00", maxWidth: 400, textAlign: "center" }, children: configError })
      ]
    }
  );
}
          ...
          children: [
            ...
            viewModel.error && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
              "view",
              {
                ...
                children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("text", { style: { color: "#dc2626", fontSize: 13 }, children: viewModel.error })
              }
            ),
            !viewModel.isLoading && /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(import_jsx_runtime12.Fragment, { children: [
              viewModel.agents.map((agent, index) => /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(
                "view",
                {
                  style: {
                    borderWidth: 1,
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(
                      "view",
                      {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("view", { style: { flexGrow: 1 } }),
                          /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
                            "button",
                            {
...
function ChatScreen({ controller: controller2 }) {
  const { viewModel, sendMessage, cancel, approve } = useChat({ controller: controller2 });
  const [settingsOpen, setSettingsOpen] = (0, import_react6.useState)(false);
  (0, import_react6.useEffect)(() => {
    void (async () => {
      await controller2.connect();
      if (controller2.getConnectionStatus() === "error") return;
      await controller2.startSession();
    })();
    return () => {
      void controller2.disconnect();
    };
  }, [controller2]);
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(
    "view",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(ThoughtBubble, { thought: viewModel.thought }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(ToolCallList, { toolCalls: viewModel.toolCalls }),
        viewModel.isConnected ? /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(import_jsx_runtime13.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(MessageList, { messages: viewModel.messages }),
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(PlanPanel, { plan: viewModel.plan }),
          viewModel.pendingPermission && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
            PermissionDialog,
            {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(MessageInput, { input: viewModel.input, onSend: sendMessage })
        ] }) : /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
...
var Globals = globalThis.Globals;
var relayUrl = Globals?.relayUrl ?? "ws://localhost:3001";
var transport = new RelayMockTransport({ url: relayUrl });
var controller = new ChatController({ transport });
render(/* @__PURE__ */ (0, import_jsx_runtime14.jsx)(ChatScreen, { controller }));
